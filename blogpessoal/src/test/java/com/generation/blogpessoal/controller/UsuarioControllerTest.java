...
public class UsuarioControllerTest {
	...
	void start () {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "admin","admin@admin.com", "12345678", " "));
	}
	
@Test
@DisplayName ("Cadastrar um usuário")
public void deveCriarUmUsuario() {
	HttpEntity<Usuario> corpoRequisicao = new  HttpEntity <Usuario> (new Usuario (0L, "Thalyta Campos", "thalyta@thalyta.com", "12345678", " "));
...
public void deveAtualizarUmUsuario() {
	...
	ResponseEntity<Usuario> corpoResposta = testRestTemplate
		.withBasicAuth("admin@admin.com", "12345678")
